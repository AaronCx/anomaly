 ...
 * GitHub brand mark.
 *
 * lucide-react removed brand icons (including `Github`) in v1.0, so we ship a
 * small self-contained SVG that mirrors the lucide icon API (className, size,
 * currentColor stroke) for the few places we need the GitHub logo.
 */
