...
export default function Home() {
  ...
  return (
    <main className="app-backdrop bg-grid relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-6 py-20">
      ...
      <div className="animate-fade-in relative z-10 flex w-full max-w-2xl flex-col items-center gap-12">
        <HeroSection />
