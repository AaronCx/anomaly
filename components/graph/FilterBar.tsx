...
export default function FilterBar({ activeFilters, onToggle, onReset }: FilterBarProps) {
  ...
  return (
    <div className="fixed left-1/2 top-4 z-30 flex -translate-x-1/2 items-center gap-1.5 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)]/80 px-3 py-1.5 backdrop-blur-md">
      <button
        onClick={onReset}
